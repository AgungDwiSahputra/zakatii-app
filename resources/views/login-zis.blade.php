...
<html lang="en">
  <head>
    ...
    <!-- Css -->
    <link rel="stylesheet" href="{{ asset('assets/css/login-zis.css') }}">

  </head>
  <body class="">
    
    <!-- container -->
    <div class="container p-0 m-0" id="login">
        <div class="row">
            <div class="col-lg-7 col-12 p-5 text-center d-flex flex-column justify-content-center align-items-center" id="signin_page">
                <p class="fs-2 fw-bold" id="judul">Sign In to Zakatii</p>
