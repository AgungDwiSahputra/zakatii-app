...
@section('content')
    ...
    <div class="container" id="progress-penggalangan">
        <div class="row">
            <a href="{{ route('overview-sedekah') }}" class="text-black nav-link fw-bold ms-4 ms-lg-0"><i class="fa-solid fa-arrow-left fa-xl text-black"></i> Kembali</a>
            <h1 class="text-center">Pembayaran Zakat Infaq/Sedekah</h1>
                ...
                <div class="list-input fade" id="page-data-diri" data-page="2">
                    <div class="d-flex align-items-center justify-content-center flex-column flex-lg-row">
                        ...
                        <div class="rincian text-light text-center ms-lg-4 w-lg-0 w-100">
                            ...
                            <h4 class="m-0 p-0"><u class="fw-bold m-0 p-0">Infaq/Sedekah</u></h4>
