...
@section('content')
    ...
    <div class="container" id="progress-penggalangan">
        <div class="row">
            <a href="{{ route('overview-fitrah') }}" class="text-black nav-link fw-bold ms-4 ms-lg-0"><i class="fa-solid fa-arrow-left fa-xl text-black"></i> Kembali</a>
            <h1 class="text-center">Pembayaran Zakat Fitrah</h1>
            ...
            <form method="POST" action="#" class="input-progress mt-5">
                <div class="list-input active" id="page-nominal" data-page="1">
                    <h6 class="fw-bold text-center">Niat Zakat Fitrah (diri sendiri)</h6>
                    <p class="text-center m-0 p-0">Nawaytu an ukhrija zakaata al-fitri `an nafsi fardhan lillahi ta`ala</p>
                    <p class="text-center">“Aku niat mengeluarkan zakat fitrah untuk diriku sendiri, fardu karena Allah Ta`âlâ.”</p>
                ...
                <div class="list-input fade" id="page-data-diri" data-page="2">
                    <div class="d-flex align-items-center justify-content-center flex-column flex-lg-row">
                        ...
                        <div class="rincian text-light text-center ms-lg-4 w-lg-0 w-100">
                            ...
                            <h4 class="m-0 p-0"><u class="fw-bold m-0 p-0">Zakat Fitrah</u></h4>
                ...
                <div class="list-input fade" id="page-success" data-page="4">
                    <div class="d-flex align-items-center justify-content-around flex-column flex-lg-row">
                        <div class="bukti-transaksi text-center order-lg-1 order-2 mt-lg-0 mt-5">
                            ...
                            <span class="text-danger">* File dalam bentuk .jpg/.png</span>
                        </div>
