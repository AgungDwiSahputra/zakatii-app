...
<body>
    ...
    <div id="hero-section" class="container w-100 m-0" style="background: url('assets/img/hero-image.jpg');background-size:cover;background-repeat:no-repeat;background-position:top center;max-width: 1750px;height: 92vh;">
        <div class="row">
            <div class="col-md-12">
                <h1>#PrayMarocco&Libya</h1>
                <p>Ribuan tempat tinggal rusak, ribuan orang meninggal dan jutaan orang luka-luka akibat bencana gempa bumi</p>
            </div>
        </div>
    </div>
